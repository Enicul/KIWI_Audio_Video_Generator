  ...
  return (
    <div className="min-h-screen bg-kiwi-black bg-pattern flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Gradient Glow */}
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-kiwi-gray-800/20 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-kiwi-gray-700/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-kiwi-gray-400">
            Join KIWI-Video and start your video journey
          </p>
        </div>
